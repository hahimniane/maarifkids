...
import '../EventProgram/admin_event_add_new_event_page.dart';
// class AdminAddNewFoodListPage extends StatefulWidget {
//   const AdminAddNewFoodListPage({super.key});
//
//   @override
//   State<AdminAddNewFoodListPage> createState() => _AdminAddNewFoodListPageState();
// }
//
...
//     return  Scaffold(
//       appBar: buildAppBar(title: foodListString, context: context, isFromSearch: false,isAdminColor: true,
//
//       ),
//       body: Column(
//         children: [
//           Expanded(
//             child: CustomActivityList(dates: dates, selectedDate: selectedDate!, onDateSelected: (DateTime date) {
//               setState(() {
//                 selectedDate = date;
//               });
//
            ...
            trailing: Container(
              ...
              child: DropdownButton<String>(
                ...
                setState(() {
                  ...
                  print(newValue); // You can replace this with your logic
                },
              ),
            ),
          )
