...
class AdminServiceSingleStudentDetailesPage extends StatelessWidget {
  final bool isFromSearch;
  const AdminServiceSingleStudentDetailesPage(
      {super.key, required this.isFromSearch, required Student student});
