...
import 'package:maarifkids/admin_module/SchoolService/service_assistant/student_detailed_page.dart';
...
class Student {
  ...
  bool enteredSchool;
  bool enteredHome;
  bool gotOnTheBusTowardHomeToggle;
  bool enteredSchoolToggle;
  bool gotOnTheBusTowardsTheSchoolToggle;
  bool gotHomeToggle;
  ...
  Student({
    ...
    this.gotOnBus = false,
    this.gotOnTheBusTowardsTheSchoolToggle = true,
    this.gotOnTheBusTowardHomeToggle = true,
    this.enteredSchool = false,
    this.enteredSchoolToggle = true,
    this.enteredHome = false,
    this.gotHomeToggle = true,
  });
}

class AdminServiceAssistantServiceStudentServiceResultPage
    extends StatefulWidget {
  const AdminServiceAssistantServiceStudentServiceResultPage({super.key});

  @override
  _AdminServiceAssistantServiceStudentServiceResultPageState createState() =>
      _AdminServiceAssistantServiceStudentServiceResultPageState();
}

class _AdminServiceAssistantServiceStudentServiceResultPageState
    extends State<AdminServiceAssistantServiceStudentServiceResultPage>
  ...
  Widget buildStudentList({required bool goingToSchool}) {
    List studentWentToSchoolToggle = [
      false,
      true,
      true,
      true,
        ...
        return GestureDetector(
          onTap: () {
            NavigationHelper.pushPage(
                context,
                AssistantStudentDetailedServicePage(
                  isFromSearch: false,
                ));
          },
          child: Card(
                          ...
                          Expanded(
                              child: student.gotOnBus
                                  ? Switch(
                                      ...
                                      value:
                                          student.gotOnTheBusTowardHomeToggle,
                                      onChanged: (value) {
                                        print(
                                            'toggle at index $index is ${studentWentToSchoolToggle[index]}');
                                        setState(() {
                                          student.gotOnTheBusTowardHomeToggle =
                                              value;
                                        });
                        ...
                        children: [
                          ...
                          Expanded(
                              child: Switch(
                                  ...
                                  activeColor: Colors.white,
                                  activeTrackColor: Colors.teal,
                                  value: student.enteredSchoolToggle,
                                  onChanged: (value) {
                                    print(
                                        'toggle at index $index is ${studentWentToSchoolToggle[index]}');
                                    setState(() {
                                      student.enteredSchoolToggle = value;
                                    });
                                    print(
                                        'toggle at index $index is ${studentWentToSchoolToggle[index]}');
                                  })
