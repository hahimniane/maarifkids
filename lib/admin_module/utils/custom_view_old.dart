...
class CustomViewOldPage extends StatelessWidget {
 ...
 final  TextEditingController dateController;
  ...
  final bool isTitleRequired;
   ...
   CustomViewOldPage({super.key,required this.gradeController,required this.dateController, required this.appBarTitleString, required this.nextPage,  this.isTitleRequired=false});
