...
class CustomViewOldPage extends StatelessWidget {
 ...
 final  TextEditingController dateController;
  ...
  final bool isItHealthPage;
   ...
   CustomViewOldPage({super.key,required this.gradeController,required this.dateController, required this.appBarTitleString, required this.nextPage,  this.isTitleRequired=false,  this.isItHealthPage=false});
                        ...
                        children: [
                          ...
                          Container(width: 210, child: TextField(
                            decoration: InputDecoration(
                              suffixIcon: Icon(
                                Icons.search,color: adminAppColor,
                              )
                            ),
                            textAlign: TextAlign.center,
                          ),),
